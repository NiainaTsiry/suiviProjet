...
<div class="midde_cont">
            ...
            <div class="col-md-12">
                <div class="page_title" style="font-weight:bold;">
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <a href="<?php echo base_url() ?>index.php/suiviProjet.php/projet_district?region=<?php echo $region ?>&&secteur=<?php echo $codeSecteur; ?>&&debut=<?php echo $anneeDeb ?>&&fin=<?php echo $anneeFin ?>"><button type="button" class="btn btn-block btn-sm btn-danger"><i class="fa fa-reply"></i>retour</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="white_shd full margin_bottom_30">
                        <div class="full graph_head">
                            <form action="<?php echo base_url() ?>index.php/suiviProjet.php/projet_commune" method="GET" class="form-row">
                                <input type="hidden" name="region" value="<?php echo $region; ?>" />
                                <input type="hidden" name="district" value="<?php echo $district; ?>" />

                                <div class="col-md-2">
                                    <input type="hidden" name="secteur" value="<?php echo $codeSecteur ?>">
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-1">
                                    <a href="<?php echo base_url() ?>index.php/suiviProjet.php/projet_commune?region=<?php echo $region ?>&&district=<?php echo $district; ?>&&secteur=<?php echo $codeSecteur; ?>"><button type="button" class="btn btn-block btn-sm btn-outline-danger" id="afficher">Voir Tout</button></a>
                                </div>
                                <div class="col-md-1">
                                </div>
                            </form>
                            ...
                            <div class="table-responsive-sm">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $val = null;
                                        while ($i < count($liste)) { ?>
                                            <?php if ($dist != $liste[$i]['commune_libelle_v']) { ?>
                                                <?php $val = $liste[$i];
                                                $dist = $liste[$i]['commune_libelle_v'];
                                                $cmp = $i; ?>
                                                <tr>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/suiviProjet.php/liste_projet?sec=<?php echo $nomSecteur; ?>&&debut=<?php echo $anneeDeb; ?>&&fin=<?php echo $anneeFin; ?>&&region=<?php echo $liste[$i]['region_id_v']; ?>&&district=<?php echo $liste[$i]['district_id_v']; ?>&&commune=<?php echo $liste[$i]['commune_id_v']; ?>">
                                                            <span style="color: black;"><?php echo $liste[$i]['commune_libelle_v']; ?></span>
                                                        </a>
                                                    </td>
                                                <?php } ?>
                                                <?php for ($j = 0; $j < count($types); $j++) { ?>
                                                    <?php if ($i < count($liste)) { ?>
                                                        <?php if (($dist == $liste[$i]['commune_libelle_v']) && ($types[$j]['type_projet'] == $liste[$i]['type_projet'])) { ?>
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/suiviProjet.php/liste_projet?sec=<?php echo $nomSecteur; ?>&&debut=<?php echo $anneeDeb; ?>&&fin=<?php echo $anneeFin; ?>&&region=<?php echo $val['region_id_v']; ?>&&district=<?php echo $val['district_id_v']; ?>&&commune=<?php echo $val['commune_id_v']; ?>">
                                                        details
                                                    </a>
                                                </td>
                                                </tr>
    ...
    <script>
        ...
        lien.href = "http://localhost/suiviProjet/index.php/crud.php/nouveau?secteur=<?php echo ($details[0]['secteur_code']); ?>&&region=<?php echo $detRegion[0]['region_id']; ?>&&district=<?php echo ($detDistrict[0]['district_id']); ?>&&commune=";
    </script>
