            ...
            <div class="col-12 col-sm-12 col-md-12 " style="margin-top: 20px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/crud.php/ajout" method="post"
                            id="frmLogin">
                            <div class="form-row">
                            <div class="col-6 col-sm-6 col-md-6">
                                ...
                                <div class="col-6 col-sm-6 col-md-6">
                                    ...
                                    <input type="text" name="partenaire" class="form-control"  value="<?php echo $projet['partenairenom'] ?>" readonly/>

                                </div>
                                <div class="col-6 col-sm-6 col-md-6">
                                    <label for="selectData">Date de validation(OS) :</label>
                                    <input type="text" name="dateval" class="form-control" value="<?php echo $dateOs ?>" readonly/>

                                </div>
                                <div class="col-6 col-sm-6 col-md-6">
                                    <label for="selectData">Annee d'engagement :</label>
                                    <input type="number" name="engagement" class="form-control" value="<?php echo $projet['anneeengagementcp'] ?>" readonly/>

                                </div>
                                <div class="col-6 col-sm-6 col-md-6">
                                    <label for="selectData">Type de financement:</label>
                                    <input type="text" name="financement" class="form-control" value="<?php echo $financementName ?>" readonly/>
                                </div>
                            </div>
                                <div class="container"><br />
                                    <button type="submit" class="btn btn-warning btn-block" id="btnvalid">
                                        Ajouter une autre Idée</button>
                                </div>
                            </div>
                        </form>
                    </div>
