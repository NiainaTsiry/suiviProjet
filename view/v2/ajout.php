...
<div class="topbar">
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="logo_section" style="padding: 10px;">
      <h2 class="" style="font-weight:bold;color:#fff;margin-top:5px;font-size:large;">NOUVEAU IDEE DE PROJET</h2>
    </div>
  </nav>
</div>
      ...
      <div class="col-md-12" style="height:400px">
        <div class="white_shd full margin_bottom_30">
          <div class="full graph_head">
            ...
            <form action="<?php echo base_url(); ?>index.php/crud.php/Nouveaueidee" method="post" id="frmLogin">
              <div class="form-row">
                ...
                <div class="col-12 col-sm-12 col-md-12">
                  ...
                  <textarea id="libelle" name="libelle" rows="3" cols="50" class="form-control"></textarea>
                </div>
              </div>
              <div class="form-row">
                ...
                <div class="col-4 col-sm-4 col-md-4">
                  ...
                  <?php if ($district == '') { ?>
                    <?php ?>
                    <select id='selectDistrict' name='district' class='form-control' onchange="selectedDistrict()"
                      required>
                      <option value=''>
                      </option>
                ...
                <div class="col-4 col-sm-4 col-md-4">
                  ...
                  <?php } else { ?>
                    <select id='selectCommune' name='commune' class='form-control'
                      required>
              ...
              <div class="container"><br />
                <button type="" onclick="myFunction()" class="btn btn-warning btn-block" id="btnLogin">
                  Valider</button>
              </div>
            </form>
          </div>
