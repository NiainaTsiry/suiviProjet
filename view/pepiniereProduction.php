  ...
  ?>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Gestion registre pepinière</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/activite.php/pepiniereProduction?tableName=pepiniere">Pepinière</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/activite.php/pepiniereProduction?tableName=pepiniere_production">Production</a></li>
              <li class="breadcrumb-item active"><a href="<?php echo base_url();?>index.php/activite.php/pepiniereProduction?tableName=pepiniere_sortie">Sortie</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
