                                ...
                                <div class="d-flex justify-content-between">
                                  <h4 class="card-title">Filtre </h4>
                                      <div class="card-tools">
                                       <a href="#" onclick="initializeFilter()">Réinitialiser tous les filtres</a>
                                </div>
                                </div>
                              </div>
...
$('#afficher').click(function(){
   ...
   function updateTable(dateDebut,appreciationProjet,region) {
    ...
    var action = baseUrl+"index.php/activite.php/getDataToLoadWithFilter.php";
                   ...
                   var $this = $(this);
                            ...
                            $.ajax({
                               ...
                               type:"POST",
                               dataType: "html",
                               data:{dateDebut:dateDebut,appreciationProjet:appreciationProjet,region:region},
